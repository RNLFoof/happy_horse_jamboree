...
testing.play_hand({ "A" }, { centers = "j_mig_horse_chipschipschips" })end, function()return 
...
testing.play_hand({ "J" }, { centers = "j_mig_horse_chipschipschipsjack" })end, function()return 
...
testing.play_hand({ "T" }, { centers = "j_mig_horse_chipschipschipsjack" })end, function()return 
testing.assert_hand_scored(10 + 5)end }), 



testing.Test("multmultmult", { testing.create_state_steps(), function()return 
testing.play_hand({ "A" }, { centers = "j_mig_horse_multmultmult" })end, function()return 
...
"j_mig_horse_moneymoneymoney", 
"j_mig_horse_moneymoneymoney", 
"j_mig_horse_moneymoneymoney" } })end, function()return 
