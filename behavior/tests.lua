...
_obj_0[#_obj_0 + 1] = testing.TestBundle("useful_things", {
	testing.Test("wrap_method", {
		function()
			...
			local obj = {
				fun = function()
					buildup[#buildup + 1] = "middle"
				end
			}
			useful_things.wrap_method(obj, "fun", (function()
				buildup[#buildup + 1] = "before"
			end), (function()
				buildup[#buildup + 1] = "after"
			end))
			obj.fun()
			return testing.assert_eq(table.concat(buildup, "_"), "before_middle_after")
		end
	}),
	testing.Test("lerp", {
		function()
			...
			return testing.assert_eq(useful_things.lerp(4, 8, 0.5), 6)
		end
	}),
	testing.Test("normalize", {
		function()
			...
			return testing.assert_eq(useful_things.normalize(1, 5, 5), 1)
		end
	})
})
