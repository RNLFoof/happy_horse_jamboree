...
self == G.jokers then local segments_deep = 
0;local ecc = 
get_effective_card_count()local effective_card_limit = 
get_effective_card_limit()for k, card in 

ipairs(self.cards) do local segment_span = 
